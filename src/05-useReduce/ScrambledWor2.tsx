...
export const ScrambleWords2 = () => {
  const [state, dispatch] = useReducer(scrambleWorsReducer, functionInitial());
  ...
  const handlePlayAgain = () => {
    dispatch({ type: "RESET_GAME", payload: functionInitial() });
  };
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      dispatch({ type: "SET_GUES", payload: e.target.value });
                    }}
